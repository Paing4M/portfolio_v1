    ...
    return (
      <>
        {NAME.split('').map((item, index) => (
          <span key={index}
                className={`name-animation-${item} name-animation inline-block opacity-0 ${index} first:uppercase tracking-tight`}>
              {item}
          </span>)
        )}
      </>
    ...
    <Container id='home' ref={component}>
      <div
        ...
        <div ref={imgContainer} className='relative w-full h-full '>
          ...
          {/* solar system */}
          <div className='absolute w-[13rem] h-[13rem] md:w-[15em]  md:h-[15rem] left-[50%] top-[20%]'>
            <Image width={100} height={100} src={'/hero/3.png'} alt={'earth'}
                   className='w-fit h-full object-contain img opacity-0 z-[5]'/>
          </div>

          <div className='absolute w-[5em] h-[5rem]  z-[8] left-[10%] md:left-[10%] top-[50%]'>
            <Image width={100} height={100} src={'/hero/4.png'} alt={'hero-4'}
                   className='w-fit h-full object-contain img opacity-0'/>
          </div>

          <div className='absolute w-[4rem] h-[4rem] z-[8] left-[15%] md:left-[30%] top-[2%] md:top-[10%]'>
            <Image width={100} height={100} src={'/hero/2.png'} alt={'hero-2'}
                   className='w-fit h-full object-contain img opacity-0'/>
          </div>

          <div className='absolute w-[3rem] h-[3rem] z-[8] right-[18%] md:right-[30%] top-[2%] md:top-[10%]'>
            <Image width={100} height={100} src={'/hero/1.png'} alt={'hero-1'}
                   className='w-fit h-full object-contain img opacity-0'/>
          </div>


          <div className='absolute w-[3rem] h-[3rem] z-[8] right-[25%] bottom-[25%]'>
            <Image width={100} height={100} src={'/hero/5.png'} alt={'hero-5'}
                   className='w-fit h-full object-contain img opacity-0'/>
          </div>

          <div className='absolute w-[3rem] h-[3rem] z-[8] left-[20%] top-[30%]'>
            <Image width={100} height={100} src={'/hero/6.png'} alt={'hero-6'}
                   className='w-fit h-full object-contain img opacity-0'/>
          </div>

          <div className='absolute w-[2rem] h-[2rem] z-[8] left-[25%] md:left-[30%] bottom-[10%] md:bottom-[30%]'>
            <Image width={100} height={100} src={'/hero/7.png'} alt={'hero-7'}
                   className='w-fit h-full object-contain img opacity-0'/>
          </div>

          {/* main */}
          <div
            className='absolute bottom-[-8%] sm:bottom-[-20%] md:bottom-[40%] left-[50%] w-[22rem]  h-[22rem]  translate-x-[-50%] md:translate-y-[40%] z-[5]'>
            <Image
              src={'/hero/main.png'}
              alt={'main-img'}
              width={200}
              height={200}
              className={'object-contain w-full opacity-0 h-full main-img z-[6]'}
            />
          </div>
        </div>
